<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ProjectWPW2_klp2/Sidebar.Master" CodeBehind="Peminjaman.aspx.vb" Inherits="Project_wpw2.Peminjaman" %>
            ...
            <table style="padding: 20px;">
                <tr>
                    <td style="height: 194px; background-color: white; width: 1408px">
                        <asp:Label ID="judul" runat="server" Text="Peminjaman Masuk" style="font-family: 'Lucida Sans'; font-size: 40px; font-weight: bold"></asp:Label> 
                    </td>
                </tr>
                <tr>
                   ...
                   <tr style="border-bottom-color:grey">
                       <td>
                           <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="id_peminjaman" DataSourceID="SqlDataSource1"  style="
                                ...
                                text-align: center;
                               " AutoGenerateEditButton="True" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal">
                               <Columns>
                                   ...
                                   <asp:BoundField DataField="jam_awal_pinjam" HeaderText="Waktu Mulai" SortExpression="jam_awal_pinjam" />
                                   <asp:BoundField DataField="jam_akhir_pinjam" HeaderText="Waktu Selesai" SortExpression="jam_akhir_pinjam" />
                           ...
                           <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:projek_wpw2ConnectionString %>" SelectCommand="SELECT DISTINCT * FROM [peminjaman_ruangan] WHERE ([status_peminjaman] = @status_peminjaman)" UpdateCommand="UPDATE [peminjaman_ruangan] SET status_peminjaman=@status_peminjaman where id_peminjaman=@id_peminjaman">
                               <SelectParameters>
